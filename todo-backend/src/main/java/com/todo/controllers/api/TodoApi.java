...
public interface TodoApi {
    ...
    ResponseEntity<TodoDto> getTodo(
            @ApiParam(value = "The Todo id", required = true) @PathVariable(value = "todoId") Long todoId
    );
    ...
    ResponseEntity<TodoDto> deleteTodo(
            @ApiParam(value = "The Todo id", required = true) @PathVariable(value="id") Long id
    );
}