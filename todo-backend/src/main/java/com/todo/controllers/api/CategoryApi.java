...
public interface CategoryApi {
    ...
    ResponseEntity<List<TodoDto>> getAllTodoByCategoriesId(
            @ApiParam(value = "Category ID", required = true) @PathVariable(value = "id") Long id
    );
    ...
    ResponseEntity<List<CategoryDto>> getAllTodoByCategoriesForToday(
    ...
    ResponseEntity<List<CategoryDto>> getAllCategoriesByUserId(
            @ApiParam(value = "User ID", required = true) @PathVariable(value = "id") Long id
    );
    ...
    ResponseEntity<CategoryDto> getCategory(
            @ApiParam(value = "The category id", required = true) @PathVariable(value = "id") Long id
    );
